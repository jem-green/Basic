...
10 PRINT TAB<18);"M0RRIST0WN, NEU JERSEY"
...
120 PRINT "UELCOME TO 'WAR3'. TUO OR THREE HUMANS MAY PLAY!"
130 PRINT "DO YOU WISH SOME ASSISTANCE";
140 INPUT A$
150 IF A$="YES" THEN 1310
160 PRINT ""
17$ PRINT "NO. OF PLAYERS";
180 INPUT N
190 IF N=2 THEN 240
200 IF N=3 THEN 270
...
410 PRINT "ERR0R-ILLE6AL TRIANGLE. RE-ENTER RANGES."
420 RESTORE
430 GOTO 290
440 NEXT J
450 PRINT
460 FOR J=1 TO N
470 PRINT "NUZZLE VELOCITY (FT./SEC.) OF ";J;
480 INPUT V(J)
490 NEXT J
500 PRINT ""
510 FOR J=1 TO N
520 LET X(J)=V(J)^2/32
530 NEXT J
340 FOR A=1 TO N
550 FOR B*1 TO N
560 IF X(A)>R(A,B) THEN 610
570 PRINT "ERROR-11;AJ" CANNOT REACH M;B
580 PRINT "UHAT IS THE NUZZLE VELOCITY OF ";A;
590 INPUT V(A)
600 GOTO 510
610 NEXT B
620 NEXT A
...
710 IF M<> 1 THEN 730
720 LET C=2
730 PRINT "PLAYER ";M;" SHO0TIN6 AT ";C
740 GOTO 890
...
930 GOTO 970
940 PRINT "ERROR—FIRED INTO 6R0UND. ";M;" NOw DEFUNCT."
950 LET P(M)=12
960 GOTO 760
970 IF A3<90 THEN 1000
980 PRINT "ERROR-FIRED UR0N6 HAY, LOSE SHOT."
990 GOTO 760
1000 LET Z=SIN(A3*3.49064E-02)*V(M)^2/32
1010 LET X=(R(M,C)/1000*RND(1))-<R(M,C)/1006*RND(1))
1020 LET D=X+Z
1030 LET D1=R(M,C)*.O5
...
1300 GOTO 650
1310 PRINT
1320 PRINT "THIS IS A WAR GAME. TUO OR THREE PLAYERS ARE GIVEN"
1330 PRINT "(THEORETICAL) CANNONS WITH WHICH THEY ATTEHPT TO SHOOT EACH"
...
1370 PRINT
1380 PRINT "THE COHPUTER WILL KEEP TRACK OF THE GAME AND REPORT ALL"
