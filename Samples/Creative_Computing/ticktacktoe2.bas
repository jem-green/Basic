...
20 DIM S(9)
30 PRINT"DO YOU WANT 'X' OR 'O'"
50 INPUT C$
55 IF C$="X"THEN 475
60 LET P$="O": LET Q$="X"
100 LET G=-1: LET H=1: IF S(5)<>0 THEN 103
102 S(5)=-1:GOTO 195
103 IF S(5)<>1 THEN 106
104 IF S(1)<>0 THEN 110
105 LET S(1)=-1: GOTO 195
...
178 LET S(I)=-1: GOTO 195
179 NEXT I
181 LET S(1)=-1: GOTO 195
182 IF S(1)=1 THEN 177
183 LET S(3)=-1: GOTO 195
187 LET S(7)=-1: GOTO 195
189 LET S(9)=-1
...
467 GOTO 175
475 LET P$="X": LET Q$="O"
500 PRINT:PRINT"WHERE DO YOU MOVE": INPUT M
