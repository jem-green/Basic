...
20 PRINT TAB(27);"CREATIVE COMPUTING"
22 PRINT
24 PRINT
26 PRINT
...
380 REM- HAZARD WARNING & LOCATION
390 GOSUB 2000
...
530 GOTO 560
540 REM- WIN
550 PRINT "HEE HEE HEE - THE WUMPUS'LL GET YOU NEXT TIME!!"
560 FOR J=1 TO 6
570 LET L(J)=M(J)
580 NEXT J
...
1160 PRINT "FEET AND IS TOO BIG FOR A BAT TOO LIFT).  USUALLY"
...
1290 PRINT "     IF THE ARROW CAN'T GO THAT WAY (IF NO TUNNEL) IT ";
1295 PRINT "MOVES"
1300 PRINT "     AT RANDOM TO THE NEXT ROOM."
1310 PRINT "       IF THE ARROW HITS THE WUMPUS, YOU WIN."
1320 PRINT "       IF THE ARROW YOU, YOU LOSE."
1330 PRINT
1340 PRINT "     WARNINGS:"
...
3105 IF P(K)<>P(K-2) THEN 3115
3105 PRINT "ARROWS AREN'T THA TCROOKED - TRY ANOTHER ROOM"
3110 GOTO 3080
3115 NEXT K
...
3400 LET L(2)=S(L(2),K)
3410 IF L(2)<>L THEN 3440
3240 PRINT "TSK TSK TSK - WUMPUS GOT YOU!"
3430 LET F=-1
3440 RETURN
