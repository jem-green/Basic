...
370 LET T=INT(RND(1)*20+20)*100: LET T0=T: LET T9=25+INT(RND(1)*10): LET D0=0: LET E=3000: LET E0=E
440 LET P=10: LET P0=P: LET S9=200: LET S=0: LET B9=2: LET K9=0: LET X$="": LET X0$=" IS "
470 DEF FND(D)=SQR((K(I,1)-S1)^2+(K(I,2)-S2)^2)
475 DEF FNR(R)=INT(RND(R)*7.98+1.01)
480 REM INITIALIZE ENTERPRIZE'S POSITION
490 LET Q1=FNR(1): LET Q2=FNR(1): LET S1=FNR(1): LET S2=FNR(1)
...
820 FOR I=1 TO 8: FOR J=1 TO 8: LET K3=0: LET Z(I,J)=0: LET R1=RND(1)
850 IF R1>.98 THEN LET K3=3: LET K9=K9+3: GOTO 980
860 IF R1>.95 THEN LET K3=2: LET K9=K9+2: GOTO 980
870 IF R1>.80 THEN LET K3=1: LET K9=K9+1
980 LET B3=0: IF RND(1)>.96 THEN LET B3=1: LET B9=B9+1
1040 LET G(I,J)=K3*100+B3*10+FNR(1): NEXT J: NEXT I: IF K9>T9 THEN LET T9=K9+1
1100 IF B9<>0 THEN 1200
1150 IF G(Q1,Q2)<200 THEN LET G(Q1,Q2)=G(Q1,Q2)+120: LET K9=K9+1
1160 LET B9=1: LET G(Q1,Q2)=G(Q1,Q2)+10: LET Q1=FNR(1): LET Q2=FNR(1)
1200 LET K7=K9: IF B9<>1 THEN LET X$="S": LET X0$=" ARE "
...
1300 LET I=RND(1): REM IF INP(1)=13 THEN 1300
1310 REM HERE ANY TIME NEW QUADRANT ENTERED
1320 LET Z4=Q1: LET Z5=Q2: LET K3=0: LET B3=0: LET S3=0: LET G5=0: LET D4=.5*RND(1): LET Z(Q1,Q2)=G(Q1,Q2)
...
1540 LET S3=G(Q1,Q2)-100*K3-10*B3: IF K3=0 THEN 1590
...
1600 FOR I=1 TO 3: LET K(I,3)=0: NEXT I: LET Q$=Z$+Z$+Z$+Z$+Z$+Z$+Z$+LEFT$(Z$,17)
1660 REM POSITION ENTERPRISE IN QUADRANT, THEN PLACE "K3" KLINGONS, &
1670 REM "B3" STARBASES, & "S3" STARS ELSEWHERE.
1680 LET A$="<*>": LET Z1=S1: LET Z2=S2: GOSUB 8670: IF K3<1 THEN 1820
1720 FOR I=1 TO K3: GOSUB 8590: LET A$="+K+": LET Z1=R1: LET Z2=R2
1780 GOSUB 8670: LET K(I,1)=R1: LET K(I,2)=R2: LET K(I,3)=S9*(0.5+RND(1)): NEXT I
1820 IF B3<1 THEN 1910
1880 GOSUB 8590: LET A$=">!<": LET Z1=R1: LET B4=R1: LET Z2=R2: LET B5=R2: GOSUB 8670
1910 FOR I=1 TO S3: GOSUB 8590: LET A$=" * ": LET Z1=R1: LET Z2=R2: GOSUB 8670: NEXT I
1980 GOSUB 6430
...
2490 LET N=INT(W1*8+.5):IF E-N>=0 THEN 2590
...
2610 LET A$="   ": LET Z1=K(I,1): LET Z2=K(I,2): GOSUB 8670: GOSUB 8590
2660 LET K(I,1)=Z1: LET K(I,2)=Z2: LET A$="+K+": GOSUB 8670
2700 NEXT I: GOSUB 6000: LET D1=0: LET D6=W1: IF W1>=1 THEN LET D6=1
2770 FOR I=1 TO 8: IF D(I)>=0 THEN 2880
2790 LET D(I)=D(I)+D6: IF D(I)>-.1 AND D(I)<0 THEN LET D(I)=-.1: GOTO 2880
2800 IF D(I)<0 THEN 2880
2810 IF D1<>1 THEN LET D1=1: PRINT "DAMAGE CONTROL REPORT:  ";
2840 PRINT TAB(8);:LET R1=I: GOSUB 8790: PRINT G2$;" REPAIR COMPLETED."
2880 NEXT I: IF RND(1)>.2 THEN 3070
2910 LET R1=FNR(1): IF RND(1)>=.6 THEN 3000
2930 LET D(R1)=D(R1)-(RND(1)*5+1): PRINT "DAMAGE CONTROL REPORT:  ";
2960 GOSUB 8790:PRINT G2$;" DAMAGED": PRINT: GOTO 3070
3000 LET D(R1)=D(R1)+RND(1)*3+1: PRINT "DAMAGE CONTROL REPORT:  ";
3030 GOSUB 8790: PRINT G2$;" STATE OF REPAIR IMPROVED":PRINT
3060 REM BEGIN MOVING STARSHIP
3070 LET A$="   ": LET Z1=INT(S1): LET Z2=INT(S2): GOSUB 8670
3110 LET X1=C(C1,1)+(C(C1+1,1)-C(C1,1))*(C1-INT(C1)): LET X=S1: LET Y=S2
3140 LET X2=C(C1,2)+(C(C1+1,2)-C(C1,2))*(C1-INT(C1)): LET Q4=Q1: LET Q5=Q2
3170 FOR I=1 TO N: LET S1=S1+X1: LET S2=S2+X2: IF S1<1 OR S1>=9 OR S2<1 OR S2>=9 THEN 3500
3240 LET S8=INT(S1)*24+INT(S2)*3-26:IF MID$(Q$,S8,2)="  " THEN 3360
...
3370 LET A$="<*>": LET Z1=INT(S1): LET Z2=INT(S2):GOSUB 8670:GOSUB 3910: LET T8=1
3430 IF W1<1 THEN LET T8=.1*INT(10*W1)
3450 LET T=T+T8: IF T>T0+T9 THEN 6220
...
3550 LET S2=INT(Y-Q2*8): IF S1=0 THEN LET Q1=Q1-1:S1=8
...
3870 LET T=T+1: GOSUB 3910: GOTO 1320
...
4410 LET E=E-X: IF D(7)<0 THEN LET X=X*RND(1)
4450 LET H1=INT(X/K3): FOR I=1 TO 3: IF K(I,3)<=0 THEN 4670
4480 LET H=INT((H1/FND(0))*(RND(1)+2)): IF H>.15*K(I,3) THEN 4530
4500 PRINT "SENSORS SHOW NO DAMAGE TO ENEMY AT ";K(I,1);",";K(I,2): GOTO 4670
4530 LET K(I,3)=K(I,3)-H: PRINT H;"UNIT HIT ON KLINGON AT SECTOR";K(I,1);",";
4550 PRINT K(I,2):IFK(I,3)<=0THENPRINT"*** KLINGON DESTROYED ***":GOTO4580
4560 PRINT"   (SENSORS SHOW";K(I,3);"UNITS REMAINING)":GOTO4670
4580 LET K3=K3-1: LET K9=K9-1: LET Z1=K(I,1): LET Z2=K(I,2): LET A$="   ": GOSUB 8670
4650 LET K(I,3)=0: LET G(Q1,Q2)=G(Q1,Q2)-100: LET Z(Q1,Q2)=G(Q1,Q2): IF K9<=0 THEN 6370
...
4730 IF D(5)<0 THEN PRINT "PHOTON TUBES ARE NOT OPERATIONAL":GOTO1990
4760 INPUT "PHOTON TORPEDO COURSE (1-9)";C1: IF C1=9 THEN LET C1=1
4780 IF C1>=1 AND C1<9 THEN 4850
4790 PRINT "ENSIGN CHEKOV REPORTS,  'INCORRECT COURSE DATA, SIR!'"
4800 GOTO 1990
4850 LET X1=C(C1,1)+(C(C1+1,1)-C(C1,1))*(C1-INT(C1)): LET E=E-2: LET P=P-1
4860 LET X2=C(C1,2)+(C(C1+1,2)-C(C1,2))*(C1-INT(C1)): LET X=S1: LET Y=S2
...
5000 PRINT"               ";X3;",";Y3: LET A$="   ": LET Z1=X: LET Z2=Y:GOSUB 8830
5050 IF Z3<>0 THEN 4920
5060 LET A$="+K+": LET Z1=X: LET Z2=Y: GOSUB 8830: IF Z3=0 THEN 5210
5110 PRINT"*** KLINGON DESTROYED ***": LET K3=K3-1: LET K9=K9-1:IF K9<=0 THEN 6370
5150 FOR I=1 TO 3: IF X3=K(I,1) AND Y3=K(I,2) THEN 5190
5180 NEXT I: LET I=3
5190 LET K(I,3)=0: GOTO 5430
5210 LET A$=" * ": LET Z1=X: LET Z2=Y: GOSUB 8830: IF Z3=0 THEN 5280
5260 PRINT "STAR AT";X3;",";Y3;"ABSORBED TORPEDO ENERGY.": GOSUB 6000: GOTO 1990
5280 LET A$=">!<": LET Z1=X: LET Z2=Y: GOSUB 8830: IF Z3=0 THEN 4760
...
5430 LET Z1=X: LET Z2=Y: LET A$="   ":GOSUB 8670
5470 LET G(Q1,Q2)=K3*100+B3*10+S3: LET Z(Q1,Q2)=G(Q1,Q2): GOSUB 6000: GOTO 1990
...
6060 LET H=INT((K(I,3)/FND(1))*(2+RND(1))):LET S=S-H:LET K(I,3)=K(I,3)/(3+RND(0))
...
6140 LET R1=FNR(1):LET D(R1)=D(R1)-H/S-.5*RND(1):GOSUB 8790
...
6450 IF INT(I+.5)<1 OR INT(I+.5)>8ORINT(J+.5)<1ORINT(J+.5)>8THEN6540
6490 LET A$=">!<": LET Z1=I: LET Z2=J: GOSUB 8830: IF Z3=1 THEN 6580
6540 NEXT J:NEXT I: LET D0=0: GOTO 6650
6580 LET D0=1: LET C$="DOCKED": LET E=E0: LET P=P0
6620 PRINT "SHIELDS DROPPED FOR DOCKING PURPOSES": LET S=0: GOTO 6720
...
6770 LET O1$="---------------------------------": PRINT O1$: FOR I=1 TO 8
...
7350 PRINT: LET H8=1: ON A+1 GOTO 7540,7900,8070,8500,8150,7400
...
7400 LET H8=0:LET G5=1:PRINT"                        THE GALAXY":GOTO 7550
...
7740 LET Z4=I: LET Z5=1: GOSUB 9030: LET J0=INT(15-.5*LEN(G2$)): PRINT TAB(J0);G2$;
7800 LET Z5=5: GOSUB 9030: LET J0=INT(39-.5*LEN(G2$)): PRINT TAB(J0);G2$;
7850 PRINT "": PRINT O1$: NEXT I: PRINT "": GOTO 1990
7890 REM STATUS REPORT
7900 PRINT "   STATUS REPORT:": LET X$="": IF K9>1 THEN LET X$="S"
7940 PRINT "KLINGON";X$;" LEFT: ";K9
7960 PRINT "MISSION MUST BE COMPLETED IN";(0.1*INT((T0+T9-T)*10));"STARDATES"
7970 LET X$="S": IF B9<2 THEN LET X$="": IF B9<1 THEN 8010
...
8080 LET X$="":IF K3>1 THEN LET X$="S"
8090 PRINT "FROM ENTERPRISE TO KLINGON BATTLE CRUSER";X$
8100 LET H8=0: FOR I=1 TO 3: IF K(I,3)<=0 THEN 8480
8110 LET W1=K(I,1):LET X=K(I,2)
8120 LET C1=S1: LET A=S2: GOTO 8220
...
8220 LET X=X-A: LET A=C1-W1: IF X<0 THEN 8350
...
8350 IF A>0 THEN LET C1=3:GOTO8420
8360 IF X<>0 THEN LET C1=5:GOTO8290
8410 LET C1=7
...
8500 IF B3<>0 THEN PRINT"FROM ENTERPRISE TO STARBASE:":LET W1=B4:LET X=B5:GOTO8120
...
8590 LET R1=FNR(1):LET R2=FNR(1):LET A$="   ":LET Z1=R1:LET Z2=R2:GOSUB 8830:IF Z3=0 THEN 8590
8600 RETURN
...
8700 LET Q$=LEFT$(Q$,S8-1)+A$+RIGHT$(Q$,190-S8): RETURN
8780 REM PRINTS DEVICE NAME
8790 ON R1 GOTO 8792,8794,8796,8798,8800,8802,8804,8806
8792 LET G2$="WARP ENGINES":RETURN
8794 LET G2$="SHORT RANGE SENSORS":RETURN
8796 LET G2$="LONG RANGE SENSORS":RETURN
8798 LET G2$="PHASER CONTROL":RETURN
8800 LET G2$="PHOTON TUBES":RETURN
8802 LET G2$="DAMAGE CONTROL":RETURN
8804 LET G2$="SHIELD CONTROL":RETURN
8806 LET G2$="LIBRARY-COMPUTER":RETURN
...
9035 GOTO 9120
9040 LET G2$="ANTARES":GOTO9210
9050 LET G2$="RIGEL":GOTO9210
9060 LET G2$="PROCYON":GOTO9210
9070 LET G2$="VEGA":GOTO9210
9080 LET G2$="CANOPUS":GOTO9210
9090 LET G2$="ALTAIR":GOTO9210
9100 LET G2$="SAGITTARIUS":GOTO9210
9110 LET G2$="POLLUX":GOTO9210
9120 ON Z4 GOTO 9130,9140,9150,9160,9170,9180,9190,9200
9130 LET G2$="SIRIUS":GOTO9210
9140 LET G2$="DENEB":GOTO9210
9150 LET G2$="CAPELLA":GOTO9210
9160 LET G2$="BETELGEUSE":GOTO9210
9170 LET G2$="ALDEBARAN":GOTO9210
9180 LET G2$="REGULUS":GOTO9210
9190 LET G2$="ARCTURUS":GOTO9210
9200 LET G2$="SPICA"
9210 IF G5<>1 THEN ON Z5 GOTO 9230,9240,9250,9260,9230,9240,9250,9260
9220 RETURN
9230 LET G2$=G2$+" I":RETURN
9240 LET G2$=G2$+" II":RETURN
9250 LET G2$=G2$+" III":RETURN
9260 LET G2$=G2$+" IV":RETURN
