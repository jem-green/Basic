<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wumpus.aspx.cs" Inherits="uBasicWeb.Wumpus" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>uBasic - WUmpus</title>
        ...
        <script type="text/javascript">
            ...
            function CaptureKey(event) {
                ...
                if (event.which == null) {
                    ...
                    char =  String.fromCharCode(event.which);	  // Firefox
                }
                else {
                    char = event.char;
                }
